...
`vmforge info` and the experimental `vmforge net` helper:

![vmforge info and net args output](assets/screenshots/cli-info.png)

`vmforge diagnose` — redacted host/VM diagnostics bundle for bug reports:
